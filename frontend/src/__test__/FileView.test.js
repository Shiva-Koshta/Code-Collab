...
const editorRefMock = {
  current: {
    ...
    setValue: jest.fn(), // Mock the setOption function
...
//   });
  ...
  test('it does not call handleSaveFile when beforeunload event is triggered without a current file', () => {
      ...
      // Render the component with mock props
      act(() => {
        render(<FileView handleSaveFile={mockHandleSaveFile} currentFile={mockCurrentFile} socketRef={socketRefMock} />, container);
      });
