...
const About = () => {
    ...
    return (
        ...
        >
            <div
                className="flex justify-start gap-5 border-2 border-gray-600 bg-black"
                style={{
                    color: "white",
                    fontSize: "24px",
                    fontWeight: "bold",
            ...
            <div className="grid grid-cols-12 h-3/4 mx-12 gap-8">
                <div className="col-span-7 text-right p-8 relative">
                ...
                <div className="col-span-5 object-fill pr-20">
