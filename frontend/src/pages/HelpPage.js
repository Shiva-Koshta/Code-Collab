...
const HelpPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Toasters for appropriate Response.
      if (response.ok) {
            ...
            <div className='stepcontent flex flex-col lg:flex-row items-center'>
              <div className='stepinfo lg:w-1/2 lg:text-left'>
                ...
                <p>
                  ...
                  password option and rest follows like the 'Forgot password'
                  option in Gmail.
                </p>
              </div>
              <div className='stepimage lg:w-1/2'>
          ...
          <div className='step'>
            <div className='stepcontent flex flex-col lg:flex-row items-center'>
              ...
              <div className='stepinfo lg:w-1/2 lg:text-left'>
                ...
                <p>
                  If you want to create a new room, click on the “Create New
                  Room option”.
                </p>
                <p>
            ...
            <div className='stepcontent flex flex-col lg:flex-row items-center'>
              <div className='stepinfo lg:w-1/2 lg:text-left'>
                ...
                <p>
                  ...
                  currently present in the same room as you would be able to
                  view it and all changes made to it.
                </p>
                <p>
                  <b>CONNECTED USERS HERE:</b> Here, you can see the usernames
                  of all connected users in the room.
                </p>
                <p>
                  <b>COPY ROOM ID:</b> This allows you to copy your current room
                  ID so that you can share it with the collaborators to your
                  project.
                </p>
                <p>
                  <b>LEAVE:</b> This button prompts the user to leave the
                  current room the user is in.
                </p>
                <p>
                  <b>EDITOR:</b> The code editor has real-time synchronization
                  to handle multiple cursors at the same time. All users present
                  in a room currently can modify the editor’s code.
                </p>
                <p>
                  <b>CHAT:</b> This button opens up a chat box where you can
                  communicate with other users in the same room as you.
                </p>
              </div>
              <div className='stepimage lg:w-1/2'>
            ...
            <div className='w-full lg:w-1/2'>
              ...
              >
                ...
                <div className='flex justify-center'>
                  <button
                    type='submit'
                    className='relative max-w-xs h-12 bg-blue-600 text-white text-lg mr-3 border-none rounded-md cursor-pointer outline-none mb-6 hover:bg-blue-700 flex items-center justify-center w-full'
                  >
                    {isSubmitting ? (
                  ...
                  <button
                    ...
                    className='relative max-w-xs h-12 bg-blue-600 text-white ml-3 text-lg border-none rounded-md cursor-pointer outline-none mb-6 hover:bg-blue-700 flex items-center justify-center w-full'
                  >
                    Back to Login
                  </button>
                </div>
